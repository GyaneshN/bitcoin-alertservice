...
exports.getBulkVideos = exports.getSingleVideo = exports.uploadToS3 = void 0;
...
const getSingleVideo = (key, bucketName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getBulkVideos = (key, bucket) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getBulkVideos = getBulkVideos;
